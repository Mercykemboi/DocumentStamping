...
from django.urls import path
from .views import CreateStampView, ListStampsView,GenerateOTPView,VerifyOTPView,StampDocumentView,VerifyStampedDocumentView
...
urlpatterns = [
    ...
    path("verifyDocument/", VerifyStampedDocumentView.as_view(), name="verify_document"),
]
